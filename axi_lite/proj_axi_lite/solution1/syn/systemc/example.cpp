...
example::example(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_add_ln102_1_fu_58_p2);
    sensitive << ( b_read_reg_69 );
    sensitive << ( add_ln102_fu_53_p2 );

    SC_METHOD(thread_add_ln102_fu_53_p2);
    ...
    sc_trace(mVcdFile, add_ln102_1_fu_58_p2, "add_ln102_1_fu_58_p2");
    sc_trace(mVcdFile, ap_CS_fsm_state2, "ap_CS_fsm_state2");
    sc_trace(mVcdFile, add_ln102_fu_53_p2, "add_ln102_fu_53_p2");
...
void example::thread_ap_clk_no_reset_() {
  ...
  esl_seteq<1,1,1>(ap_const_logic_1, c_1_vld_reg.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_1, ap_const_logic_1)))) {
        c_1_data_reg = add_ln102_1_fu_58_p2.read();
    }
}

void example::thread_add_ln102_1_fu_58_p2() {
    add_ln102_1_fu_58_p2 = (!add_ln102_fu_53_p2.read().is_01() || !b_read_reg_69.read().is_01())? sc_lv<8>(): (sc_biguint<8>(add_ln102_fu_53_p2.read()) + sc_biguint<8>(b_read_reg_69.read()));
}

void example::thread_add_ln102_fu_53_p2() {
    add_ln102_fu_53_p2 = (!a_read_reg_64.read().is_01() || !c_0_data_reg.read().is_01())? sc_lv<8>(): (sc_biguint<8>(a_read_reg_64.read()) + sc_biguint<8>(c_0_data_reg.read()));
}
...
void example::thread_ap_block_state3() {
    ap_block_state3 = (esl_seteq<1,2,2>(c_1_state.read(), ap_const_lv2_1) || (esl_seteq<1,1,1>(ap_const_logic_0, ap_const_logic_1) && 
  esl_seteq<1,2,2>(c_1_state.read(), ap_const_lv2_3)));
}

void example::thread_ap_done() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
         !(esl_seteq<1,2,2>(c_1_state.read(), ap_const_lv2_1) || (esl_seteq<1,1,1>(ap_const_logic_0, ap_const_logic_1) && 
  esl_seteq<1,2,2>(c_1_state.read(), ap_const_lv2_3))))) {
...
void example::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 2 : 
            ...
            break;
        case 4 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && !(esl_seteq<1,2,2>(c_1_state.read(), ap_const_lv2_1) || (esl_seteq<1,1,1>(ap_const_logic_0, ap_const_logic_1) && 
  esl_seteq<1,2,2>(c_1_state.read(), ap_const_lv2_3))))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else {
                ap_NS_fsm = ap_ST_fsm_state3;
