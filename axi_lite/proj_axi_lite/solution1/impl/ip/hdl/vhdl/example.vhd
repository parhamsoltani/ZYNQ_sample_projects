...
architecture behav of example is 
    ...
    "example,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-2,HLS_INPUT_CLOCK=13.333000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.966000,HLS_SYN_LAT=2,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=128,HLS_SYN_LUT=124,HLS_VERSION=2019_1}";
    ...
    signal add_ln102_1_fu_58_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal add_ln102_fu_53_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal c_1_state : STD_LOGIC_VECTOR (1 downto 0);
...
begin
    ...
    c_1_state(1 downto 0) <= "00";

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state3, c_1_state)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if ((not(((c_1_state = ap_const_lv2_1) or ((ap_const_logic_1 = ap_const_logic_0) and (c_1_state = ap_const_lv2_3)))) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state3;
                end if;
    ...
    add_ln102_1_fu_58_p2 <= std_logic_vector(unsigned(add_ln102_fu_53_p2) + unsigned(b_read_reg_69));
    add_ln102_fu_53_p2 <= std_logic_vector(unsigned(a_read_reg_64) + unsigned(c_0_data_reg));
    ap_CS_fsm_state1 <= ap_CS_fsm(0);
    ap_CS_fsm_state2 <= ap_CS_fsm(1);
    ap_CS_fsm_state3 <= ap_CS_fsm(2);

    ap_block_state3_assign_proc : process(c_1_state)
    begin
                ap_block_state3 <= ((c_1_state = ap_const_lv2_1) or ((ap_const_logic_1 = ap_const_logic_0) and (c_1_state = ap_const_lv2_3)));
    end process;


    ap_done_assign_proc : process(ap_CS_fsm_state3, c_1_state)
    begin
        if ((not(((c_1_state = ap_const_lv2_1) or ((ap_const_logic_1 = ap_const_logic_0) and (c_1_state = ap_const_lv2_3)))) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state3, c_1_state)
    begin
        if ((not(((c_1_state = ap_const_lv2_1) or ((ap_const_logic_1 = ap_const_logic_0) and (c_1_state = ap_const_lv2_3)))) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    c_0_ack_out_assign_proc : process(ap_CS_fsm_state2, ap_CS_fsm_state3, c_1_state)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) or (not(((c_1_state = ap_const_lv2_1) or ((ap_const_logic_1 = ap_const_logic_0) and (c_1_state = ap_const_lv2_3)))) and (ap_const_logic_1 = ap_CS_fsm_state3)))) then 
