proc getPresetInfo {} {
  return [dict create name {Zynq7020} description {Zynq7020}  vlnv xilinx.com:ip:processing_system7:5.5 display_name {Zynq7020} ]
}
...
proc apply_preset {IPINST} {
  return [dict create \
    ...
    CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {20.0}  \
    CONFIG.PCW_FPGA2_PERIPHERAL_FREQMHZ {70}  \
